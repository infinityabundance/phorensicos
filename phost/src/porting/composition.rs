...
// one composed target whose implementation is a chain of already-sealed native
...
//
// The composition adds no new trusted code: its implementation *is* the two
// already-sealed objects. The court records the per-stage native/fallback/
